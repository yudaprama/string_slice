...
func TestCombineStringSlices(t *testing.T) {
	...
	combined, additions := CombineStringSlices(s1, s2)
	t.Run("Length Test", func(t *testing.T) {
...
func TestRemoveStringsFromSlice(t *testing.T) {
	...
	removed, removedCount := RemoveStringsFromSlice(root, remove)
	t.Run("Length Test", func(t *testing.T) {
...
func TestRemoveStringsFromSliceReturnsNewSlice(t *testing.T) {
	root := []string{"ok", "removeme1", "removeme2", "ok2"}
	removed, _ := RemoveStringsFromSlice(root, nil)
	root[0] = "nope"
